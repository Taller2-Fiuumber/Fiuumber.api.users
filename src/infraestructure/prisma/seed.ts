...
const createPassengers = async () => {
    ...
    await createPassenger("jnramirez@fiuumber.com", "Jeremias", "Ramirez","unsername", encryptedPassword, "Calle Falsa 123", "claveprivada$$");
    await createPassenger("elpapu@fiuumber.com.ar", "El", "Papu","unsername", encryptedPassword, "Calle Falsa 124", "claveprivada$$");
